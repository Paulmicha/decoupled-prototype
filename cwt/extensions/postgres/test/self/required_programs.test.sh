...
##
# postgres extension program-related tests.
#
...
# @see cwt/extensions/postgres/test/self_test.hook.sh
#
# @example
#   cwt/extensions/postgres/test/self/required_programs.test.sh
#
...
#
test_postgres_extension_required_programs() {
  local p
